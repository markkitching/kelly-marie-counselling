...
MARKER = "  # ─── generated by scripts/gen-pages-yml.py — edit that script, not what follows ───\n"

yml = yml_before
if MARKER not in yml:
    raise SystemExit("`.pages.yml` has lost its generated-section marker; put it back "
                     "after the last hand-written entry.")
